...
upgrade advice do not describe the Redis 7.4.10 MinGW release.

Use the current documentation instead:

- [Redis for Windows](README.md) for the supported build and quick start.
- [Redis 7.4 behavior in the Windows port](WINDOWS-7.4-CHANGES.md) for explicit
  differences from original Redis on Linux/POSIX and for upgrade constraints.
- [Running Redis 7.4 as a Windows service](Windows%20Service%20Documentation.md)
