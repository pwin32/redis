...
long scanLaterTmplArray(robj *ob, dict_ulong *cursor, monotime endtime) {
    serverAssert(ob->type == OBJ_HASH && ob->encoding == OBJ_ENCODING_TMPL_ARRAY);
...
static doneStatus defragRegistryDict(dict **dref, dict_ulong *cursor, monotime endtime) {
...
static void beginDefragCycle(void) {
    ...
    addDefragStage(defragStageHashTemplates, zfree, zcalloc(sizeof(size_t)));
    addDefragStage(defragStageHashTemplatesByFields, zfree, zcalloc(sizeof(dict_ulong)));
    addDefragStage(defragStageHashTemplatesByFieldsLp, zfree, zcalloc(sizeof(dict_ulong)));
    addDefragStage(defragStageHashTemplatesById, zfree, zcalloc(sizeof(size_t)));
