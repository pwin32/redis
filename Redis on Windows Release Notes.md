# Historical MSOpenTech Redis on Windows release notes
...
not the release record for this repository's current Redis 7.4.10 line.
...
[WINDOWS-7.4-CHANGES.md](WINDOWS-7.4-CHANGES.md) for Windows/Linux behavior and
upgrade differences. The historical 3.2 text remains available in Git history.
