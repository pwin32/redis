...
# The Windows IOCP port intentionally supports only the main client I/O
# thread.  Keep the upstream qualification tests in the tree, but do not try
# to start their multi-I/O-thread server configurations on Windows.
