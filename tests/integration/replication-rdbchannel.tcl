...
set background_transfer_error_patterns {"*Background transfer error*"}
if {$::tcl_platform(platform) eq "windows"} {
    # QFork cancellation is reported through the Windows SIGUSR1 status.
    lappend background_transfer_error_patterns "*Background transfer terminated by signal 30*"
}
...
start_server {tags {"repl external:skip"}} {
    ...
    start_server {} {
        ...
        test "Test master memory does not increase during replication" {
            ...
            if {$max_retry == 0} {
                error "assertion:Replica not in sync before the test deadline"
            }
    ...
    start_server {} {
        ...
        start_server {} {
            ...
            test "Test master aborts rdb delivery if all replicas are dropped" {
                ...
                wait_for_log_messages -2 $background_transfer_error_patterns $loglines 1000 50
            }
...
start_server {tags {"repl external:skip"}} {
    ...
    start_server {} {
        ...
        test "Test replica recovers when rdb channel connection is killed" {
            ...
            wait_for_log_messages -1 $background_transfer_error_patterns $loglines 1000 10
        ...
        test "Test replica recovers when main channel connection is killed" {
            ...
            wait_for_log_messages -1 $background_transfer_error_patterns $loglines 1000 20
