...
tags {"aof external:skip"} {
    ...
    test "Short read: Utility should confirm the AOF is not valid" {
            ...
            exec $::redis_check_aof_path $aof_manifest_file
        } result
    ...
    test "Short read: Utility should be able to fix the AOF" {
        set result [exec $::redis_check_aof_path --fix $aof_manifest_file << "y\n"]
    ...
    test {Truncate AOF to specific timestamp} {
        ...
        exec $::redis_check_aof_path --truncate-to-timestamp 1628217473 $aof_manifest_file
        start_server_aof [list dir $server_path] {
            set c [redis [srv host] [srv port] 0 $::tls]
            wait_done_loading $c
            assert_equal "bar1" [$c get foo1]
        ...
        exec $::redis_check_aof_path --truncate-to-timestamp 1628217471 $aof_manifest_file
        start_server_aof [list dir $server_path] {
            set c [redis [srv host] [srv port] 0 $::tls]
            wait_done_loading $c
            assert_equal "bar1" [$c get foo1]
        ...
        exec $::redis_check_aof_path --truncate-to-timestamp 1628217470 $aof_manifest_file
        start_server_aof [list dir $server_path] {
            set c [redis [srv host] [srv port] 0 $::tls]
            wait_done_loading $c
            assert_equal "bar1" [$c get foo1]
        ...
        catch {exec $::redis_check_aof_path --truncate-to-timestamp 1628217469 $aof_manifest_file} e
    ...
    test {Test redis-check-aof for old style resp AOF} {
        create_aof $aof_dirpath $aof_file {
            ...
            exec $::redis_check_aof_path $aof_file
        } result
    ...
    test {Test redis-check-aof for old style rdb-preamble AOF} {
            ...
            exec $::redis_check_aof_path tests/assets/rdb-preamble.aof
        } result
    ...
    test {Test redis-check-aof only truncates the last file for Multi Part AOF in fix mode} {
        ...
        assert_match "*not valid*" $result
            ...
            exec $::redis_check_aof_path --fix $aof_manifest_file
        } result
