...
- package revision tag: `v8.8.1-windows.1`;
- portable archive: `Redis-x64-8.8.1-mingw-r1.zip`; and
- adjacent checksum: `Redis-x64-8.8.1-mingw-r1.zip.sha256`.
...
case-insensitive rule. Atomic replacement is
