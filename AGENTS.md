...
This repository maintains the Redis Windows port. The canonical MinGW lines
track Redis 6.2.23, 7.2.15, 7.4.10, 8.8.1, and 8.10.0. This branch is the
`mingw-7.2` maintenance line for Redis 7.2.15.
